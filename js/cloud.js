...
const Cloud = (() => {
  ...
  const SYNCED_SETTINGS = ['initialBankroll', 'bookrolls', 'model', 'apiKey', 'oddsApiKey', 'apiFootballKey', 'oddsSource', 'onlyMyBooks', 'stakingMode', 'maxExposurePct', 'notifyAlerts', 'currency', 'showEurEquiv', 'freeTierGuard', 'convictionStakePct'];
